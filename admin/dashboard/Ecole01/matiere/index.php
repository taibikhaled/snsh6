...
$sqll='Select * from matiere_ecole order by id desc LIMIT '.$debut.', 5 ;';
...
<form enctype="multipart/form-data" method="POST" action="ins.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Libellé :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Libellé ..." value="<?php if (isset($_POST['lib_matiere_ecole'])) print $_POST['lib_matiere_ecole'];?>" >
     </div>
