        ...
        <div class="content-wrapper">
          ...
          <div class="row m-1">
              ...
              <div class="col-xl-6 col-lg-6">
                    ...
                    $sqll="select count(id) from inscription_ecole where sexe='F' ";
                    ...
                    $sqll="select count(id) from inscription_ecole where sexe='M' ";
...
$sqll="SELECT DATE(DAT), count(ID) FROM `inscription_ecole` GROUP by DATE(DAT)";
...
$sqll="SELECT id_formation, designation, COUNT(id_inscription) FROM `inscription_ecole_choix` WHERE choix=1 group by id_formation, designation ";
