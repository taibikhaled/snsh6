	...
	if ($test_pj ==true) $f_pj=$nomDestination_f_pj; else $f_pj='';
	 ...
	 $dat=date("Y-m-d H:i:s");   
	  ...
	  //preparation de la requete
	  	...
	  	//$sql = 'INSERT INTO evenement (ref, titre, content, dat, f_img, f_pj)  VALUES (:ref, :titre, :content, :dat, :f_img, :f_pj) ';
		//$datas = array(':ref'=>$ref , ':titre'=>$titre,':content'=>$content,':dat'=>$dat, ':f_img'=>$f_img,':f_pj'=>$f_pj );

		$sql = 'INSERT INTO evenement (ref, titre, content, dat, f_img, f_pj, content_text)  VALUES (:ref, :titre, :content, :dat, :f_img, :f_pj, :content_text) ';
