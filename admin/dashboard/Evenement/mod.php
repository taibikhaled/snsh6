...
if(isset($_POST['submit'])){
					...
					if ($nomOrigine!="")
						
						{
							...
							// Copie dans le repertoire du script avec un nom
												...
												$repertoireDestination = $path."backup/Evenement/Pieces/";
	...
	if (isset($_FILES['file2'])) 
		{
					...
					
					{
						...
						// Copie dans le repertoire du script avec un nom
											...
											$repertoireDestination = $path."backup/Evenement/Images/";
	...
	if ($test_pj ==true) $f_pj=$nomDestination_f_pj; else $f_pj='';
	 ...
	 $dat=date("Y-m-d H:i:s");   
	  ...
	  //$sql = "UPDATE evenement SET ref=:ref , titre=:titre, content=:content, dat=:dat, f_img=:f_img, f_pj=:f_pj WHERE id='".$idd."'";
	  //$datas = array(':ref'=>$ref , ':titre'=>$titre,':content'=>$content,':dat'=>$dat, ':f_img'=>$f_img,':f_pj'=>$f_pj );

	  $sql = "UPDATE evenement SET ref=:ref , titre=:titre, content=:content, dat=:dat, f_img=:f_img, f_pj=:f_pj, content_text=:content_text WHERE id='".$idd."'";
