...
$idd=$_GET['id'];
  ...
  $sqll='Select * from niveau_filialle where id = '.$idd.' ;';
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Niveau Filliale - Modification</h4>
<hr>
...
<form enctype="multipart/form-data" method="POST" action="mod.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Niveau Filliale :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Titre ..." value="<?php echo $rows['niveau_filialle'];?>" >
