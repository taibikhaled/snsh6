        ...
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              ...
              <div class="col-xl-6 col-lg-6">
                    ...
                    $sqll="select count(id) from inscription_oran where sexe='F' ";
                    ...
                    $sqll="select count(id) from inscription_oran where sexe='M' ";
...
$sqll="SELECT DATE(DAT), count(ID) FROM `inscription_oran` GROUP by DATE(DAT)";
...
$sqll="SELECT id_formation, designation, COUNT(id_inscription) FROM `inscription_oran_choix` WHERE choix=1 group by id_formation, designation ";
