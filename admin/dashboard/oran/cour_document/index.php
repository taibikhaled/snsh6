      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              ...
              $sql='Select * from cour_document where etablissement="EFPG-ORAN"';
              ...
              $sqll='Select * from cour_document where etablissement="EFPG-ORAN" order by id desc LIMIT '.$debut.', 5 ;';
