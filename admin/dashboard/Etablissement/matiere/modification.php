...
$idd=$_GET['id'];
  ...
  $sqll='Select * from matiere_etablissement where id = '.$idd.' ;';
...
<form enctype="multipart/form-data" method="POST" action="mod.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Référence :</label>
           <input type="text" class="form-control form-control-sm" name="ref" id="ref"  placeholder="Code.." value="<?php echo $rows['CODMAT'];?>" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Titre :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Libellé ..." value="<?php echo $rows['DESIGNATION'];?>" >
     </div>
