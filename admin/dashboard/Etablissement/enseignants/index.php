      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Spécialités</h4>
<hr>
...
$sql='Select * from enseignants_etablissement ';
...
$sqll='Select * from enseignants_etablissement order by id desc LIMIT '.$debut.', 5 ;';
...
<thead><th><h6 class="font-weight-bold text-gray-100">ID</h6></th><th><h6  class="font-weight-bold text-gray-100">Nom et Prénom</h6></th><th><h6  class="font-weight-bold text-success"><center>Modifier</center></h6></th><th><h6  class="font-weight-bold text-danger"><center>Supprimer</center></h6></th></thead>
<tbody> ';
...
$acc=$acc+1;
if (($acc>2)||($fin>5)) {
echo "<tr><td><h6><a href=".$lien."> ".$row['id']." </a></h6></td><td><h6><a href=".$lien.">" .$row['nom']."</a></h6></td><td><center><a href='modification.php?id=".$row["id"]."'> <h3 class='text-success'>  <i class='mdi mdi-table-edit menu-icon'></i> </h3> </a></center></td><td><center><a href='javascript:del(".$row['id'].")' ><h3 class='text-danger'>  <i class='mdi mdi-delete  menu-icon'></i> </h3> </a></center></td></tr>";
} else {
echo "<tr><td><h6><a href=".$lien." class='text-danger'> ".$row['id']." </a></h6></td><td><h6><a href=".$lien." class='text-danger'>" .$row['nom']."</a></h6></td><td><center><a href='modification.php?id=".$row["id"]."'> <h3 class='text-success'>  <i class='mdi mdi-table-edit menu-icon'></i> </h3></a></center></td><td><center><a href='javascript:del(".$row['id'].")' ><h3 class='text-danger'>  <i class='mdi mdi-delete menu-icon'></i> </h3> </a></center></td></tr>";
}
...
<form enctype="multipart/form-data" method="POST" action="ins.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Nom et Prénom</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Nom et Prénom"  >
     </div>
