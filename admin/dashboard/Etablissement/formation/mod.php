...
if(isset($_POST['submit'])){
	...
	$content = !empty($_POST['formation']) ? trim($_POST['formation']) : NULL;
	
	  //preparation de la requete

	 
  
	  $sql = "UPDATE equivalent_formation_etablissement SET id=:ref , designation=:titre, niveau=:content WHERE id='".$idd."'";
