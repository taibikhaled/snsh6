      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Formations</h4>
<hr>
...
$sql='Select * from equivalent_formation_etablissement';
...
$sqll='Select * from equivalent_formation_etablissement order by id desc LIMIT '.$debut.', 5 ;';
...
<thead><th><h6 class="font-weight-bold text-gray-100">ID</h6></th><th><h6  class="font-weight-bold text-gray-100">Désignation</h6></th><th><h6  class="font-weight-bold text-gray-100">formation</h6></th><th><h6  class="font-weight-bold text-success"><center>Modifier</center></h6></th><th><h6  class="font-weight-bold text-danger"><center>Supprimer</center></h6></th></thead>
<tbody> ';
...
<form enctype="multipart/form-data" method="POST" action="ins.php" >
    ...
    <select name="titre" id="titre"  class="form-control form-control-sm " >
    ...
    ?>
     ...
     <div class="form-group">
      ...
      <label class="font-weight-bold text-gray-100" for="textarea">formation :</label>
      
      <select name="formation" id="formation"  class="form-control form-control-sm " >
