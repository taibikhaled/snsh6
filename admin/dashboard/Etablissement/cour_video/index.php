      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              ...
              $sql='Select * from cour_video where etablissement="EES"';
              ...
              $sqll='Select * from cour_video where etablissement="EES" order by id desc LIMIT '.$debut.', 5 ;';
              ...
              <thead><th><h6 class="font-weight-bold text-gray-100">ID</h6></th><th><h6  class="font-weight-bold text-gray-100">Date</h6></th><th><h6  class="font-weight-bold text-gray-100">Libellé</h6></th><th><h6  class="font-weight-bold text-gray-100">Niveau et Filière</h6></th><th><h6  class="font-weight-bold text-gray-100">Matiére</h6></th><th><h6  class="font-weight-bold text-gray-100">Enseignant</h6></th><th><h6  class="font-weight-bold text-success"><center>Modifier</center></h6></th><th><h6  class="font-weight-bold text-danger"><center>Supprimer</center></h6></th></thead>
              <tbody> ';
...
<label class="font-weight-bold text-gray-100" for="textarea">Enseignant :</label>
              ...
              <div class="input-group">	
                ...
                <div class="input-group-append">
                      ...
                      <?php
                        ...
                        $pag=$path.'page/search_ens_etablissement.php';
   ...
   <div class="form-group">
     <label class="font-weight-bold text-gray-100" for="textarea">URL Youtube</label>
           <input type="text" class="form-control form-control-sm" name="url_youtube" id="url_youtube"  placeholder="url youtube ..." value="<?php if (isset($_POST['url_youtube'])) print $_POST['url_youtube'];?>" >
     </div>
    ...
    <label class="font-weight-bold text-gray-100" for="textarea"> Fichier Video : </label>

    <input type="hidden" name="fichier1" value="fichier1" />
    <input name="file1" type="file" size="30" id="file1"  accept=".mp4, .MP4" />
