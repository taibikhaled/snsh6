...
$idd=$_GET['id'];
  ...
  $sqll='Select * from cour_video where (etablissement="EES") and  (id = '.$idd.') ;';
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Cours (Video) - Modification</h4>
<hr>
...
<div class="col-xl-6 col-lg-6 ">
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Titre :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Libellé ..." value="<?php echo $lib_doc;?>" >
    ...
    <?php
        ...
        while($rows = $reqq->fetch()) {
            echo "<option value='".$rows["CLDEM"]."'>".$rows["CLDEM"]."|".$rows["SPEC"]."</option>";
          }
