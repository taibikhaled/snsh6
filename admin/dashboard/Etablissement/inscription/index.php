      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Inscriptions - <a href='statistique.php'>Statistiques</a> - <a href='moyenne.php'>Moyennes (Adminission | CNEG)</a></h4>
              <hr>
              ...
              $sql="SELECT a.id, a.dat, a.NOME, a.PRENOME, a.DATN, (c.designation) as NIVEAU, b.designation, b.choix FROM `inscription_etablissement` a, `inscription_etablissement_choix` b, `equivalent_niveau_etablissement` c where (a.id=b.id_inscription) and (a.nivs=c.id) and (b.choix='1') order by a.id";
              ...
              $sqll="SELECT a.id, a.dat ,a.NOME, a.PRENOME, a.DATN, (c.designation) as NIVEAU, b.designation, b.choix FROM `inscription_etablissement` a, `inscription_etablissement_choix` b, `equivalent_niveau_etablissement` c where (a.id=b.id_inscription) and (a.nivs=c.id) and (b.choix='1') order by a.id LIMIT ".$debut.", 5 ;";
              ...
              <thead>
                ...
                <th width="5%"><h6  class="font-weight-bold text-gray-100">Date</h6></th>
                ...
                <th width="30%"><h6  class="font-weight-bold text-gray-100">Niveau</h6></th>
                <th width="30%"><h6  class="font-weight-bold text-success">Choix</h6></th>
                </thead>
              <tbody> ';
...
<a href="down_inscription.php" class="btn btn-primary"> <i class="mdi mdi-download menu-icon">Télécharger la liste des inscrits</i></a>
</div>
<div class="col-xl-6 col-lg-6 text-left">
<a href="down_inscription_choix.php" class="btn btn-primary"><i class="mdi mdi-download menu-icon">Télécharger la liste des inscrits avec les Choix</i></a>
</div>
