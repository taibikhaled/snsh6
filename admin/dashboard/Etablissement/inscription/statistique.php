      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  -<a href='index.php'> Inscriptions</a> - Statistiques - <a href='moyenne.php'>Moyennes (Adminission | CNEG)</a></h4>
              <hr>
...
?>
              ...
              <div class="col-xl-6 col-lg-6">
                    ...
                    $sqll="select count(id) from inscription_etablissement where sexe='F' ";
                    ...
                    $sqll="select count(id) from inscription_etablissement where sexe='M' ";
...
$sqll="SELECT DATE(DAT), count(ID) FROM `inscription_etablissement` GROUP by DATE(DAT)";
...
$sqll="SELECT id_formation, designation, COUNT(id_inscription) FROM `inscription_etablissement_choix` WHERE choix=1 group by id_formation, designation ";
