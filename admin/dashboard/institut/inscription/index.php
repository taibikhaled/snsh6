      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              ...
              $sql="SELECT a.id, a.dat, a.NOME, a.PRENOME, a.DATN, (c.designation) as NIVEAU, b.designation, b.choix FROM `inscription_institut` a, `inscription_institut_choix` b, `equivalent_niveau_institut` c where (a.id=b.id_inscription) and (a.nivs=c.id) and (b.choix='1') order by a.id";
              ...
              $sqll="SELECT a.id, a.dat ,a.NOME, a.PRENOME, a.DATN, (c.designation) as NIVEAU, b.designation, b.choix FROM `inscription_institut` a, `inscription_institut_choix` b, `equivalent_niveau_institut` c where (a.id=b.id_inscription) and (a.nivs=c.id) and (b.choix='1') order by a.id LIMIT ".$debut.", 5 ;";
