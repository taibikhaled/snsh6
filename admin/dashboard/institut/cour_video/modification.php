...
//echo $idd;
  ...
  $sqll='Select * from cour_video where (etablissement="IFG") and  (id = '.$idd.') ;';
...
<label class="font-weight-bold text-gray-100" for="textarea">Enseignant :</label>
   ...
   <div class="form-group">
     <label class="font-weight-bold text-gray-100" for="textarea">URL Youtube</label>
           <input type="text" class="form-control form-control-sm" name="url_youtube" id="url_youtube"  placeholder="url youtube ..." value="<?php print $url_youtube;?>" >
     </div>
