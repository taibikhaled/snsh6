      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body ">
                  <h4 class="card-title  "><a href='../index.php'>Administration</a>  - Contact </h4>
<hr>
...
$sqll='Select * from contact order by id desc LIMIT '.$debut.', 5 ;';
...
<thead><th><h6 class="font-weight-bold text-gray-100">Date</h6></th><th><h6  class="font-weight-bold text-gray-100">Nom</h6></th><th><h6  class="font-weight-bold text-gray-100">E-mail</h6></th><th><h6  class="font-weight-bold text-danger"><center>Supprimer</center></h6></th></thead>
<tbody> ';
...
$lien="contact/index.php?id=".$row['id']."&debut=0";

$acc=$acc+1;
if (($acc>2)||($fin>5)) {
echo "<tr><td ><h6><a href=".$lien.">".$dat."</a></h6> </td><td><h6><a href=".$lien."> ".$row['nom']." </a></h6></td><td><h6><a href=".$lien.">" .$row['mail']."</a></h6></td><td><center><a href='javascript:del(".$row['id'].")' ><h3 class='text-danger'>  <i class='mdi mdi-delete  menu-icon'></i> </h3> </a></center></td></tr>";
} else {
echo "<tr><td ><h6><a href=".$lien." class='text-danger'>".$dat."</a></h6> </td><td><h6><a href=".$lien." class='text-danger'> ".$row['nom']." </a></h6></td><td><h6><a href=".$lien." class='text-danger'>" .$row['mail']."</a></h6></td><td><center><a href='javascript:del(".$row['id'].")' ><h3 class='text-danger'>  <i class='mdi mdi-delete menu-icon'></i> </h3> </a></center></td></tr>";
}
