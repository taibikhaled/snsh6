...
$idd=$_GET['id'];
  ...
  $sqll='Select * from cour_video where (etablissement="EFPG-BEJAIA") and  (id = '.$idd.') ;';
...
<label class="font-weight-bold text-gray-100" for="textarea">Enseignant :</label>
              ...
              <div class="input-group">	
                ...
                <?php
                        ...
                        $pag=$path.'page/search_ens_bejaia.php';
   ...
   <div class="form-group">
     <label class="font-weight-bold text-gray-100" for="textarea">URL Youtube</label>
           <input type="text" class="form-control form-control-sm" name="url_youtube" id="url_youtube"  placeholder="url youtube ..." value="<? print $url_youtube;?>" >
     </div>
