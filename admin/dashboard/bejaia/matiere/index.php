...
$sql='Select * from matiere_bejaia ';
...
$sqll='Select * from matiere_bejaia order by id desc LIMIT '.$debut.', 5 ;';
...
<thead><th><h6 class="font-weight-bold text-gray-100">ID</h6></th><th><h6  class="font-weight-bold text-gray-100">Code</h6></th><th><h6  class="font-weight-bold text-gray-100">Libellé</h6></th><th><h6  class="font-weight-bold text-gray-100">Spécialité</h6></th><th><h6  class="font-weight-bold text-success"><center>Modifier</center></h6></th><th><h6  class="font-weight-bold text-danger"><center>Supprimer</center></h6></th></thead>
<tbody> ';
...
<form enctype="multipart/form-data" method="POST" action="ins.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Libellé :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Libellé ..." value="<?php if (isset($_POST['lib_matiere_bejaia'])) print $_POST['lib_matiere_bejaia'];?>" >
     </div>
    ...
    <?php
        ...
        $sqll=' SELECT * FROM specialite_bejaia ';
