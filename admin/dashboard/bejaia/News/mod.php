...
if(isset($_POST['submit'])){
	...
	$ref = "E.F.P.G-BEJAIA / ".(!empty($_POST['ref']) ? trim($_POST['ref']) : NULL);
	...
	if ($test_pj ==true) $f_pj=$nomDestination_f_pj; else $f_pj='';
	 ...
	 $dat=date("Y-m-d H:i:s");   
	  ...
	  $sql = "UPDATE news SET ref=:ref , titre=:titre, content=:content, dat=:dat, f_img=:f_img, f_pj=:f_pj, content_text=:content_text WHERE id='".$idd."'";
