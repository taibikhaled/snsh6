      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-12 stretch-card">
              ...
              $sql='Select * from cour_document where etablissement="EFPG-BEJAIA"';
              ...
              $sqll='Select * from cour_document where etablissement="EFPG-BEJAIA" order by id desc LIMIT '.$debut.', 5 ;';
