...
$idd=$_GET['id'];
  ...
  $sqll='Select * from specialite where id = '.$idd.' ;';
...
<form enctype="multipart/form-data" method="POST" action="mod.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Spécialité :</label>
           <input type="text" class="form-control form-control-sm" name="titre" id="titre"  placeholder="Titre ..." value="<?php echo $rows['specialite'];?>" >
