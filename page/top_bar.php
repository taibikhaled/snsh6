...
?>         
	...
	<div class="input-group-prepend">
        ...
        if (isset($_COOKIE["langue"])) {
          ...
          echo "<li class=' nav-item dropdown no-arrow mx-1 text-center'>
          <a class='h6 bg bg-warning text-white  ' href='".$path."page/lang_supp.php'   role='button' title='Langue Française' >
          <b>Fr</b>
