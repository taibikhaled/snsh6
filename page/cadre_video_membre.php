...
<?php
     ...
     $debut=0;
$sqll='Select * from cour_video where cldem="'.$struc.'" and active=true order by id desc LIMIT '.$debut.', 4 ;';
...
?>
                  ...
                  <div class="row mt-4">
                          ...
                          <div class="h6   mb-1">
                              ...
                              <?php
                                  $lien=$path."app/fp/cvideos/index.php";
                                  echo "<a href='".$lien."'>Autres Cours(Video) ...</a>";
                              ?>
