...
$lien=$path."page/download_document.php?file=".$row['id'];
                ...
                print "<div class='col-xl-3 col-lg-3 shadow  text-left mb-2 '><a href=".$lien." ><img src='".$path."images/pdf.png' class='m-2' width='35%' height='35%' ></a><p class='p-2 text-dark'>".$dat."<br>".$row["lib_doc"]."<br>".$lib_matiere."<br>".$row["cldem"]."<h6 class='text-warning text-right'>".$row["etablissement"]."</h6></p></div>";
