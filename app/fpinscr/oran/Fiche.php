...
$sqll=' SELECT * FROM equivalent_niveau_oran where id='.$row['NIVS'];
...
$NIVS=$r['designation'];
$sqll=' SELECT * FROM inscription_oran_choix where id_inscription='.$idd;
...
$code=$idd."-".$NOME."-".$PRENOME."-".$dat."-EFPG-ORAN-".$choix1;
...
$pdf->Image($path."backup/oran/inscription/photos/".$row['PHOTO'] , 6,15.5,31.5,38);
  

$pdf->Image("images/code.png" , 184,37);
