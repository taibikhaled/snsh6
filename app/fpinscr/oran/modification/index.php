...
<body>
	...
	?> 
      ...
      <div class="main-panel">
        ...
        <div class="row mt-4 d-flex justify-content-center">
                  ...
                  <p class="card-title mb-0"><h1 class="text-center" >  Le Candidat   -   المترشح  (Modification) </h1 ></p> 
                              ...
                              <select name="nivs" id="nivs"  class="form-control form-control-sm" onblur="testForm('nivs')" onchange="testNiv();">
                                ...
                                <option value=''></option>
                                  ...
                                  <?php
                                      ...
                                      $sqll=' SELECT * FROM equivalent_niveau_oran ';
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <h4 class="modal-title text-white">Ecole de Formation Professionnelle en Gestion,  Avenue Larbi Ben Mhidi Oran  </h4>
