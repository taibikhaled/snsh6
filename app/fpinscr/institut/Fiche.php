...
$sqll=' SELECT * FROM equivalent_niveau_institut where id='.$row['NIVS'];
...
$code=$idd."-".$NOME."-".$PRENOME."-".$dat."-IFG-ALGER-".$choix1;
...
$pdf->Image($path."backup/institut/inscription/photos/".$row['PHOTO'] , 6,15.5,31.5,38);
