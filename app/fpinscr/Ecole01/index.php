...
<body>
	...
	?> 
      ...
      <div class="main-panel">
        ...
        <div class="row mt-4 d-flex justify-content-center">
                              ...
                              <select name="nivs" id="nivs"  class="form-control form-control-sm" onblur="testForm('nivs')" onchange="testNiv();">
                                ...
                                <option value=''></option>
                                  ...
                                  <?php
                                      ...
                                      $sqll=' SELECT * FROM equivalent_niveau_ecole ';
                  ...
                  <h3 class="text-center text-danger">معلومات تتعلق بعامل الشركة الذي يرغب في رعاية المترشح</h4>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <h4 class="modal-title text-white">Ecole de Formation Professionnelle en Gestion  -  CEM Haroune Rachid  </h4>
