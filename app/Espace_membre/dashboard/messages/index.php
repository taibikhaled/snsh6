...
<h4 class="card-title  ">Boite de Récéption</h4>
<hr>
          <div class="row">
                 ...
                 <?php print  '<h5 class="m-0 font-weight-bold text-primary"><a>Boite de Récéption <i class="fas fa-envelope fa-fw"></i>&nbsp<span title="Non Lus / Lus" class="badge badge-pill badge-primary badge-counter"> '.$nbr_msg_nlus.' / '.$nbr_msg.'</span></a></h5>'; ?>
               ...
               <div class="row">
                       ...
                       $sql='select * from message where from_id='.$id;
                       ...
                       $sqll='Select * from message where from_id='.$id.' order by id_msg desc LIMIT '.$debut.', 5 ;';
