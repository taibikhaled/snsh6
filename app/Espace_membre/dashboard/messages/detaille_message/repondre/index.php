...
<div class="col-xl-12 col-lg-12">
               ...
               <form enctype="multipart/form-data" name="mat" method="POST" action="ins.php" >
                     ...
                     <div class="input-group">	
                         ...
                         <input type="text" id="from_nom" class="form-control form-control-sm"  name="from_nom" placeholder="Compte" value="<?php print $ro['nom'];?>" readonly>
                         <input type="hidden" name="id" value="<?php print $id; ?>" >
                         <input type="hidden" name="from_id" id="from_id" value="<?php print $ro['id'];?>"  >
