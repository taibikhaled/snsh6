...
$sql = "UPDATE `message` SET active=:active , vue=:vue WHERE id_msg=".$id_msg;
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
                 ...
                 <h4 class='m-0 font-weight-bold text-primary'>Message <i class='fas fa-envelope fa-fw'></i></h4>
                   <?php print '<h6 class="text-primary text-right">
                   
                   <a title="Répondre" class="btn btn-primary ml-1" href="repondre/index.php?id='.sha1($id).'&id_msg='.$_GET["id_msg"].'"><i class="mdi mdi-reply menu-icon"></i></a>
                   <a title="Transférer" class="btn btn-primary ml-1" href="transferer/index.php?id='.sha1($id).'&id_msg='.$_GET["id_msg"].'"><i class="mdi fas mdi-arrow-right menu-icon"></i></a>
               ...
               <div class="row">
                       ...
                       if ($row['f_pj']!='') echo "<h5 class='text-gray-900 ml-1'> .Pièce Jointe : <a href=".$path."backup/Espace_membre/Messages/Pieces/".$row['f_pj'].">".$row['f_pj']."</a> <i class='fa fa-paperclip text-primary'></i></h5></div>";  
                        

                       print "<div class='col-xl-12 col-lg-12  m-4 p-1'>
                       <h5 class='text-gray-900'><a href='repondre/index.php?id=".sha1($id)."&id_msg=".$_GET['id_msg']."' class='btn btn-primary text-white'><i class='fas fa-reply fa-fw' ></i> Répondre</a>
                       <a href='transferer/index.php?id=".sha1($id)."&id_msg=".$_GET['id_msg']."' class='ml-4 btn btn-primary text-white'><i class='fas fa-arrow-right fa-fw'></i> Transférer</a></h5></div>";
