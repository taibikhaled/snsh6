...
$sql = "UPDATE `message_envoye` SET active=:active , vue=:vue WHERE id_msg=".$id_msg;
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
                 ...
                 <h4 class='m-0 font-weight-bold text-primary'>Message Envoyé <i class='fas fa-envelope fa-fw'></i></h4>
               ...
               <div class="row">
                       ...
                       $sqll='Select * from message_envoye where id_msg='.$id_msg;
