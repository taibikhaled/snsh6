...
<hr>
          <div class="row">
                 ...
                 <?php print  '<h5 class="m-0 font-weight-bold text-primary"><a>Alertes <i class="fas fa-envelope fa-fw"></i>&nbsp<span title="Non Lus / Lus" class="badge badge-pill badge-primary badge-counter"> '.$nbr_msg_nlus.' / '.$nbr_msg.'</span></a></h5>'; ?>
               ...
               <div class="row">
                       ...
                       $sql='select * from alerte where from_id='.$id;
                       ...
                       $sqll='Select * from alerte where from_id='.$id.' order by id_msg desc LIMIT '.$debut.', 5 ;';
                       ...
                       $lien=$path."app/Espace_membre/dashboard/alertes/detaille_alerte/index.php?msg='".sha1($row['from_id'])."'&id=".$row['from_id']."&id_msg=".$row['id_msg'];

                       
                       if ($row["vue"]=="true") {
                       echo "<tr><td ><img class='rounded-circle' width='60%' src='".$image3."' alt=''></td><td><h6><a href=".$lien."> ".$row['nom']." </a></h6></td><td><h6><a href=".$lien.">" .$row['objet']."</a></h6></td><td ><h6><a href=".$lien.">".$dat."</a></h6> </td><td><center><input type='checkbox' class='form-control-sm' name='sup[]' value='".$row['id_msg']."' ></center></td></tr>";
                       } else {
                       echo "<tr class='bg bg-gray-100'><td ><img class='rounded-circle' width='60%' src='".$image3."' alt=''></td><td><h6 class='font-weight-bold'><a href=".$lien."> ".$row['nom']." </a></h6></td><td><h6 class='font-weight-bold'><a href=".$lien." >" .$row['objet']."</a></h6></td><td ><h6 class='font-weight-bold'><a href=".$lien." >".$dat."</a></h6> </td><td><center><input type='checkbox' class='form-control-sm' name='sup[]' value='".$row['id_msg']."' ></center></td></tr>";
                       }
