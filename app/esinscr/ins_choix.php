...
if(isset($_POST['submit'])){
    ...
    $choix10 = !empty($_POST['choix10']) ? trim($_POST['choix10']) : NULL;
    $choix11 = !empty($_POST['choix11']) ? trim($_POST['choix11']) : NULL;
	...
	$des10 = !empty($_POST['des10']) ? trim($_POST['des10']) : NULL;
	$des11 = !empty($_POST['des11']) ? trim($_POST['des11']) : NULL;
	...
	$for10 = !empty($_POST['for10']) ? trim($_POST['for10']) : NULL;
	$for11 = !empty($_POST['for11']) ? trim($_POST['for11']) : NULL;


	 if ($choix1<>null) {

	
		$sql="INSERT INTO `inscription_etablissement_choix` 
	 ...
	 if ($choix10<>null) {
		...
		$datas = array(':id_for'=>$for10,':desi'=>$des10,':id_inscr'=>$idd, ':choix'=>$choix10);
	 ...
	 if ($choix11<>null) {
		...
		$datas = array(':id_for'=>$for11,':desi'=>$des11,':id_inscr'=>$idd, ':choix'=>$choix11);
