...
if (isset($_GET['id'])) {
  ...
  $connect_evenement=$path.'Config/connect_evenement.php';
  include($connect_evenement);

  $sqll="Select * from evenement where id='".$id."'";
...
<div class="card shadow mb-4">
    ...
    <br><br>
      ...
      <?php if ($rows['f_img']!='')  echo "<img class='img-fluid px-3 px-sm-4 mt-3 mb-4'  src=".$path."backup/Evenement/Images/".$rows['f_img'].">";
      ?> 
           ...
           <?php if ($rows['f_pj']!='') echo "Pièce Jointe : <a href=".$path."backup/Evenement/Pieces/".$rows['f_pj'].">".$rows['f_pj']."</a>";  ?>
           <br><br> 
    </div>
