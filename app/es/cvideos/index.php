      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0"> Recherche un Cours Video</p>
        ...
        <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Cours (Video)</p>
                  <hr class="border-warning mt-1" >
		...
		//$lien=$path."app/cvideo/index.php?id=".$row['id'];

		$lien=$path."page/download_video.php?file=".$row['id'];
                  ...
                  print "<div class='col-xl-3 col-lg-3 shadow  text-left  '><a href=".$lien." ><img src='".$path."images/video.png' class='m-2' width='35%' height='35%' ></a><p class='p-2 text-dark'>".$dat."<br>".$row["lib_doc"]."<br>".$lib_matiere."<br>".$row["cldem"]."<h6 class='text-warning text-right'>".$row["etablissement"]."</h6></p></div>";
